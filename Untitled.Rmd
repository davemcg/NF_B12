...
## Introduction
Mouse work done 97% by David Bernard. PI Lawrence Brody. CD320 (transcobamin receptr) knockout (KO) by DB, and subjected to a large set of experiments trying to suss out whether B12 transport has been affected. Since the full KO were largely healthy, DB gave the mice (and normal mice from the same background) special mouse chow that was B12 deficient and B12 positive ('normal').
